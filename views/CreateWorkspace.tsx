            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div
                  ...
                  className={`p-6 rounded-xl border-2 cursor-pointer flex flex-col items-center justify-center group transition-all h-full ${
                    setupMode === "empty"
                ...
                <div
                  ...
                  className={`p-5 rounded-xl border-2 flex flex-col relative h-full cursor-pointer transition-all ${
                    setupMode === "import"
                      ? "border-primary bg-primary/5"
                      : "border-gh-border bg-gh-bg-secondary hover:border-primary"
                  }`}
                >
                  ...
                  <div className="flex gap-2 mb-4">
                    <div
                      ...
                      className={`size-8 rounded border flex items-center justify-center cursor-pointer transition-all ${
