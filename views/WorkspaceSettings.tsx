                ...
                <section className="bg-[#161b22] border border-[#f85149]/40 rounded-xl p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#da3633] text-white font-bold rounded-lg hover:bg-[#b62324] transition-colors"
                    >
                      Delete Workspace
                    </button>
                  </div>
                      ...
                      {canManageMembers &&
                        ...
                        member.role !== "OWNER" && (
                          <button
                            ...
                            className="p-1.5 text-slate-400 hover:text-[#f85149] hover:bg-[#f85149]/10 rounded-md transition-colors"
                            title="Remove member"
                          >
